...
public class LogoutResponse  implements java.io.Serializable {
    private CxWSBasicRepsonse logoutResult;

    public LogoutResponse() {
    }

    public LogoutResponse(
           CxWSBasicRepsonse logoutResult) {
     ...
     * @param logoutResult
     */
    public void setLogoutResult(CxWSBasicRepsonse logoutResult) {
        this.logoutResult = logoutResult;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://Checkmarx.com/v7", ">LogoutResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("logoutResult");
        elemField.setXmlName(new javax.xml.namespace.QName("http://Checkmarx.com/v7", "LogoutResult"));
