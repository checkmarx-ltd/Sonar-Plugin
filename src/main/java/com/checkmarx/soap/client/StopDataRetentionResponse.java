...
public class StopDataRetentionResponse  implements java.io.Serializable {
    private CxWSBasicRepsonse stopDataRetentionResult;

    public StopDataRetentionResponse() {
    }

    public StopDataRetentionResponse(
           CxWSBasicRepsonse stopDataRetentionResult) {
     ...
     */
    public void setStopDataRetentionResult(CxWSBasicRepsonse stopDataRetentionResult) {
        this.stopDataRetentionResult = stopDataRetentionResult;
    }
