 ...
 * Results are provided as an xml file and are corresponding to the sensor defined in 'sensor.xml'.
 * To be very abstract, these sensor are applied on source files made with the fictive language Foo.
 */
public class FooLintIssuesLoaderSensor implements Sensor {
  ...
  public void describe(final SensorDescriptor descriptor) {
   ...
   // descriptor.onlyOnLanguage(FooLanguage.KEY);
    descriptor.onlyOnLanguage("mizi");
  }
